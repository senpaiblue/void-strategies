  ...
  return (
    <section className="relative  max-h-screen min-h-[80vh]  xl:min-h-[80vh] md:min-h-[70vh] flex items-start justify-center flex-col w-full py-12 md:py-0 lg:pt-8 2xl:py-10 ">
      ...
      <div className="absolute top-0 left-0 z-10 w-full h-full">
        ...
        />
      </div><div className='relative z-20 flex flex-col items-center justify-center w-full gap-5 px-6 lg:items-start sm:px-10 lg:px-20 '>
            ...
            <Link href={'/ContactUs'} className='flex items-center justify-center w-full md:justify-start '>
              <button
                className={`bg-[#F58A23] montserrat text-white  w-11/12 flex items-center justify-center px-5 py-2 rounded-full text-primary font-bold text-2xl  md:max-w-[30%] lg:max-w-[32%]`}
              > Contact Us</button>
            </Link>
          </div>
    </section>
